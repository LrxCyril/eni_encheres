		...
		<header>
			...
			<main>
				<h2>Nouvelle vente</h2>
					 ...
					 <form action="${pageContext.request.contextPath}/creer/utilisateur" method="post">
		                <fieldset>
		                    ...
		                    <c:if test="${empty requestScope.categorie}">
		                    	<p>Champs obligatoire</p>
		                    </c:if>
              ...
              <!--  --------------------------------------------------------------------------------------  -->    
		                    ...
		                    <input type="text" name="rue" id="rue" placeholder="">
		                    <c:if test="${empty requestScope.rue}">
		                    	<p>Champs obligatoire</p>
		                    </c:if>
		                    <label for="code_postal">Code postal :</label>
		                    <input type="text" name="code_postal" id="code_postal" placeholder="">
		                    <c:if test="${empty requestScope.code_postal}">
		                    	<p>Champs obligatoire</p>
		                    </c:if>
